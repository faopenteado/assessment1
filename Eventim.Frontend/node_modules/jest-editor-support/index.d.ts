...
export declare class Snapshot {
	...
	_getSnapshotResolver(): Promise<SnapshotResolver>;
	/**
	 ...
	 */
	getSnapshotContent(filePath: string, name: string | RegExp): Promise<string | SnapshotData | null>;
...
export declare class TestReconciler {
	fileStatuses: {
		[key: string]: TestFileAssertionStatus;
	};
	constructor();
